...
(* OASIS_START *)
(* DO NOT EDIT (digest: 423a744a2878db523134d04f5b944c87) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Unix targets";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Mirage targets";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "pcap"; FindlibPackage ("lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\173\027\250\201}\197\205\204ZK2\152\231\187\"\\";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
